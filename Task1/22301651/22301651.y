...
%token IF ELSE FOR ID CONST_INT CONST_FLOAT WHILE ADDOP COMMA DO INT FLOAT VOID SWITCH DEFAULT GOTO BREAK CHAR DOUBLE RETURN CASE CONTINUE PRINTLN MULOP INCOP DECOP RELOP ASSIGNOP LOGICOP NOT LPAREN RPAREN LCURL RCURL LTHIRD RTHIRD COLON SEMICOLON
...
unary_expression : ADDOP unary_expression
		...
		| NOT unary_expression
		{
			...
			$$ = new symbol_info("!"+$2->getnameofsymbol(),"unary_expr");
		}
		| factor_info
		{
...
int main(int argc, char *argv[])
{
	if(argc != 2)
	{
		cout<<"Usage: ./22301651_parser.exe input_file"<<endl;
		return 0;
	}
